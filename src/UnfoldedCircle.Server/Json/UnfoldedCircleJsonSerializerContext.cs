...
[JsonSerializable(typeof(StateChangedEvent<DeltaMediaPlayerStateChangedEventMessageDataAttributes>))]
[JsonSerializable(typeof(StateChangedEvent<RemoteStateChangedEventMessageDataAttributes>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<sbyte>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<byte>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<short>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<ushort>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<int>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<uint>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<nint>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<long>>))]
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<ulong>>))]
...
[JsonSerializable(typeof(StateChangedEvent<SensorStateChangedEventMessageDataAttributes<float>>))]
